...
- (void)updateWithQuestion:(nullable BJLQuestion *)question questionReply:(nullable BJLQuestionReply *)questionReply {
    if ([self.reuseIdentifier isEqualToString:BJPQuestionCellReuseIdentifier]) {
        ...
        self.titleLabel.attributedText = [self attributedStringWithImage:[UIImage bjp_imageNamed:@"bjp_ic_text_questionreply"] content:[NSString stringWithFormat:@"%@回复", questionReply.fromUser.displayName] contentFont:[UIFont boldSystemFontOfSize:12.0] timeInterval:questionReply.createTime timeIntervalFont:[UIFont systemFontOfSize:12.0]];
